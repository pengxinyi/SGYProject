...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy
{
	...
	[Serializable]    
    public class AutoUpdateU9PurRtnRCVDocProxy : OperationProxyBase//, UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoUpdateU9PurRtnRCVDoc
    {
	#region Fields	
	...
	#region Constructors
        public AutoUpdateU9PurRtnRCVDocProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoUpdateU9PurRtnRCVDoc>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAutoUpdateU9PurRtnRCVDoc channel = oChannel as IAutoUpdateU9PurRtnRCVDoc;
            if (channel != null)
            {
