...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy
{
	...
	[Serializable]    
    public class AutoUpdateTransferInProxy : OperationProxyBase//, UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoUpdateTransferIn
    {
	#region Fields	
	...
	#region Constructors
        public AutoUpdateTransferInProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoUpdateTransferIn>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAutoUpdateTransferIn channel = oChannel as IAutoUpdateTransferIn;
            if (channel != null)
            {
