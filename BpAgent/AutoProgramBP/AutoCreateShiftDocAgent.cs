...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy
{
	...
	[Serializable]    
    public class AutoCreateShiftDocProxy : OperationProxyBase//, UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateShiftDoc
    {
	#region Fields	
	...
	#region Constructors
        public AutoCreateShiftDocProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateShiftDoc>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAutoCreateShiftDoc channel = oChannel as IAutoCreateShiftDoc;
            if (channel != null)
            {
