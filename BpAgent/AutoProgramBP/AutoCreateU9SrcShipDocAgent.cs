...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy
{
	...
	[Serializable]    
    public class AutoCreateU9SrcShipDocProxy : OperationProxyBase//, UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateU9SrcShipDoc
    {
	#region Fields	
	...
	#region Constructors
        public AutoCreateU9SrcShipDocProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateU9SrcShipDoc>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAutoCreateU9SrcShipDoc channel = oChannel as IAutoCreateU9SrcShipDoc;
            if (channel != null)
            {
