...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy
{
	...
	[Serializable]    
    public class AutoCreateU9RMADocProxy : OperationProxyBase//, UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateU9RMADoc
    {
	#region Fields	
	...
	#region Constructors
        public AutoCreateU9RMADocProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateU9RMADoc>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAutoCreateU9RMADoc channel = oChannel as IAutoCreateU9RMADoc;
            if (channel != null)
            {
