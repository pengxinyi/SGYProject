...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy
{
	...
	[Serializable]    
    public class AutoCreateMiscShipRcvProxy : OperationProxyBase//, UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateMiscShipRcv
    {
	#region Fields	
	...
	#region Constructors
        public AutoCreateMiscShipRcvProxy()
        {
        }
        #endregion
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.LH.LHPubBP.AutoProgramBP.Proxy.IAutoCreateMiscShipRcv>();
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IAutoCreateMiscShipRcv channel = oChannel as IAutoCreateMiscShipRcv;
            if (channel != null)
            {
