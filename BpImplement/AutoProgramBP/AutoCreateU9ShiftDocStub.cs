...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    public class AutoCreateU9ShiftDocStub : ISVStubBase, IAutoCreateU9ShiftDoc
    {
        #region IAutoCreateU9ShiftDoc Members
        ...
        public System.String DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoCreateU9ShiftDoc");                
                AutoCreateU9ShiftDoc objectRef = new AutoCreateU9ShiftDoc();
            ...
            {
				FinallyInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoCreateU9ShiftDoc");
            }
        }
	#endregion
    }
