namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    /// <summary>
    /// AutoCreateU9NoSrcShipDoc partial 
    /// </summary>	
    public partial class AutoCreateU9NoSrcShipDoc 
	{	
		internal BaseStrategy Select()
		{
			return new AutoCreateU9NoSrcShipDocImpementStrategy();	
		}		
	}
	...
	/// 
	/// </summary>	
	internal partial class AutoCreateU9NoSrcShipDocImpementStrategy : BaseStrategy
	{
		public AutoCreateU9NoSrcShipDocImpementStrategy() { }

		public override object Do(object obj)
		{						
			AutoCreateU9NoSrcShipDoc bpObj = (AutoCreateU9NoSrcShipDoc)obj;
			...
			try
			{
				...
				sql = string.Format("Select top 100  ID,DocType,Json  from Cust_FailInfo where issuccess=0 and  DocType='无来源标准出货创建' order by CreatedOn");
			...
			{
				CHelper.InsertU9Log(false, "无来源标准出货创建", ex.Message, dataJson, posturl);
