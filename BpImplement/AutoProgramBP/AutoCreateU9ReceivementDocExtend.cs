namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    /// <summary>
    /// AutoCreateU9ReceivementDoc partial 
    /// </summary>	
    public partial class AutoCreateU9ReceivementDoc 
	{	
		internal BaseStrategy Select()
		{
			return new AutoCreateU9ReceivementDocImpementStrategy();	
		}		
	}
	...
	/// 
	/// </summary>	
	internal partial class AutoCreateU9ReceivementDocImpementStrategy : BaseStrategy
	{
		public AutoCreateU9ReceivementDocImpementStrategy() { }

		public override object Do(object obj)
		{						
			AutoCreateU9ReceivementDoc bpObj = (AutoCreateU9ReceivementDoc)obj;
			...
			try
			{
				...
				sql = string.Format("Select top 100  ID,DocType,Json  from Cust_FailInfo where issuccess=0 and  DocType='标准收货创建' order by CreatedOn");
			...
			{
				CHelper.InsertU9Log(false, "标准收货创建", ex.Message, dataJson, posturl);
