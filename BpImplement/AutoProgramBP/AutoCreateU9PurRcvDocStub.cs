...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    public class AutoCreateU9PurRcvDocStub : ISVStubBase, IAutoCreateU9PurRcvDoc
    {
        #region IAutoCreateU9PurRcvDoc Members
        ...
        public System.String DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoCreateU9PurRcvDoc");                
                AutoCreateU9PurRcvDoc objectRef = new AutoCreateU9PurRcvDoc();
            ...
            {
				FinallyInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoCreateU9PurRcvDoc");
            }
        }
	#endregion
    }
