namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    /// <summary>
    /// AutoCreateU9RMADoc partial 
    /// </summary>	
    public partial class AutoCreateU9RMADoc 
	{	
		internal BaseStrategy Select()
		{
			return new AutoCreateU9RMADocImpementStrategy();	
		}		
	}
	...
	/// 
	/// </summary>	
	internal partial class AutoCreateU9RMADocImpementStrategy : BaseStrategy
	{
		public AutoCreateU9RMADocImpementStrategy() { }

		public override object Do(object obj)
		{						
			AutoCreateU9RMADoc bpObj = (AutoCreateU9RMADoc)obj;
			...
			try
			{
                ...
                sql = string.Format("Select top 100  ID,DocType,Json  from Cust_FailInfo where issuccess=0 and  DocType='退回处理单创建' order by CreatedOn");
			...
			{
				CHelper.InsertU9Log(false, "退回处理单创建", ex.Message, dataJson, posturl);
