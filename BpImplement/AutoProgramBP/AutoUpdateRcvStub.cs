...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    public class AutoUpdateRcvStub : ISVStubBase, IAutoUpdateRcv
    {
        #region IAutoUpdateRcv Members
        ...
        public System.String DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoUpdateRcv");                
                AutoUpdateRcv objectRef = new AutoUpdateRcv();
            ...
            {
				FinallyInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoUpdateRcv");
            }
        }
	#endregion
    }
