...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    public class AutoUpdateSaleReturnDocStub : ISVStubBase, IAutoUpdateSaleReturnDoc
    {
        #region IAutoUpdateSaleReturnDoc Members
        ...
        public System.String DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoUpdateSaleReturnDoc");                
                AutoUpdateSaleReturnDoc objectRef = new AutoUpdateSaleReturnDoc();
            ...
            {
				FinallyInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoUpdateSaleReturnDoc");
            }
        }
	#endregion
    }
