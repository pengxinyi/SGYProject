...
namespace UFIDA.U9.LH.LHPubBP.AutoProgramBP
{
    ...
    public class AutoCreateU9DocStub : ISVStubBase, IAutoCreateU9Doc
    {
        #region IAutoCreateU9Doc Members
        ...
        public System.String DoEx(ICommonDataContract commonData)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoCreateU9Doc");                
                AutoCreateU9Doc objectRef = new AutoCreateU9Doc();
            ...
            {
				FinallyInvoke("UFIDA.U9.LH.LHPubBP.AutoProgramBP.AutoCreateU9Doc");
            }
        }
	#endregion
    }
