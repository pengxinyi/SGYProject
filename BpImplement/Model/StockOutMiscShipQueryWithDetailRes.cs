...
{
   public class StockOutMiscShipQueryWithDetailRes
    {
        public int status { get; set; }
        public string message { get; set; }

        public StockOutData data { get; set; }
      
    }

    public class StockOutData
    {
        public List<MiscShipOrderDto> order { get; set; }
        public int total_count { get; set; }
    }

    public class MiscShipOrderDto
    {
       ...
       // public int order_type { get; set; }
        ...
        public List<PurchaseReturnOrderDetail> detail_list { get; set; }
    }
    ...
    public class positiondetailslist
    { 
      //public long rec_id { get; set; }
       // public int stockout_detail_id { get; set; }
        public int  position_id { get; set; }
        public string position_no { get; set; }
        public string expire_date { get; set; }
        public string batch_no { get; set; }
        public decimal position_goods_count { get; set; }
    }
}
